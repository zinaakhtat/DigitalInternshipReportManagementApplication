...
<head>
    ...
    <link rel="stylesheet" href="../css/connection_etudiant.css">
</head>
<body>
    ...
    if(isset($_POST['connexion'])){
        ...
        if(!empty($Email) && !empty($mdp)){
            ...
            if(mysqli_num_rows($result) >= 1){
              ...
              switch ($role) {
    case 4 : 
        header('Location: ../include.php/page_etudiant/pageprincipale.php');
    ...
    ?>
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="password" id="password" name="passeword">
            </div>
            <div class="form-group">
