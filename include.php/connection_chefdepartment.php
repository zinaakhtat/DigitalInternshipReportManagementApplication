...
<head>
    ...
    <title>Connexion chef_departement</title>
    <link rel="stylesheet" href="../css/connection_chefdepartement.css">
...
<body>
    ...
    if(isset($_POST['connexion'])){
        ...
        if(!empty($Email) && !empty($mdp)){
            ...
            if(mysqli_num_rows($result) >= 1){
                ...
                switch ($role) {
      case 2 : 
          header('Location: ../include.php/page_chef/pageprincipale.php');
    ...
    ?>
        <h2>Connexion <br> chef de département </h2>
        <form method="POST">
