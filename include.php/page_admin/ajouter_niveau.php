...
if(isset($_POST['ajouter']) && $_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(!empty($_POST['nom'])) {
        ...
        $sql = "INSERT INTO `niveaux`( `Nom_niveau`) 
                VALUES ('$nom')";
        if (mysqli_query($conn, $sql)) {
            ...
            echo "<script> alert('Erreur lors de l\'ajout du niveau! Essayer une autre fois:')</script>";
            echo "Erreur lors de l'ajout du niveau: " . mysqli_error($conn);
        }
    } else {
