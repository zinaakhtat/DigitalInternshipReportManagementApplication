...
if(isset($_GET['id']) && $_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        // Affichage du formulaire de modification avec les données de l'etudiant
?>
...
<!DOCTYPE html>
 <html lang="en">
        ...
        <input type="hidden" name="id" value="<?php echo $id_etudiant; ?>"> <!-- Champ caché pour transmettre l'ID de l'utilisateur -->
            ...
            <label for="ID_niveau">ID_niveau</label>
            <input type="text" id="ID_niveau" name="ID_niveau" value="<?php echo $row['ID_niveau']; ?>" required>
        ...
        $sql = "UPDATE `etudiants` SET `ID_utilisateur`='$ID_utilisateur',`ID_filière`='$ID_filiere',`ID_niveau`='$ID_niveau'
